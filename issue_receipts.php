...
function generateAndSendReceipt($conn, $booking_id) {
    // Get booking details
    $stmt = $conn->prepare("
        SELECT a.*, u.name as client_name, u.email, u.phone, s.name as staff_name, s.role as staff_role
        FROM appointments a 
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="total">$<?= number_format($booking['payment_amount'], 2) ?></td>
                </tr>
                <?php endif; ?>
            </table>
        </div>
            ...
            ?>
              <div class="flex justify-between items-center border-b pb-3">
                ...
                <div class="text-right">
                  ...
                  <div class="text-sm">$<?= number_format($receipt['total'], 2) ?></div>
                </div>
              </div>
            <?php endwhile; ?>
          </div>
